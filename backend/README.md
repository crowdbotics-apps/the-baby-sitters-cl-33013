...
## Project Structure
    ...
    ├── the_baby_sitters_cl_33013  # Django project configurations
...
1. Clone this repo and `cd the_baby_sitters_cl_33013`
...
2. Clone this repo and `cd the_baby_sitters_cl_33013`
